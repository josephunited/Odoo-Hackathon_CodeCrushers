      ...
      <div className="glass-card p-6 rounded-2xl relative overflow-hidden">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 font-medium">Latest events across all modules</p>
            </div>
          </div>
          {setCurrentPage && (
            <button
              onClick={() => setCurrentPage('activity-logs')}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-indigo-400 hover:text-indigo-300 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/20 transition-all"
            >
              View All
